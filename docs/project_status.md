...
> **Living Document** | Last Updated: July 4, 2026 | Sprint C.2 Completed: AI Core Infrastructure
>
...
- `document_processing/` — `DocumentExtractor` ABC, `DocumentExtractionService` ABC, `DocumentContent` schema
